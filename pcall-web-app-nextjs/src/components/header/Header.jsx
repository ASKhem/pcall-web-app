    ...
    return (
        <header className="fixed z-10 t-0 flex w-full h-16 bg-custom-blue grid-rows-1 items-center justify-between px-[5vw] text-zinc-200 backdrop-opacity-60 border-b border-zinc-800">
            <div className="h-full flex items-center justify-center gap-16">
                <img src="/img/brand/pcallLogo.svg" className="h-full p-1" alt="Logo" />
            ...
            <div className="h-full lg:flex hidden items-center justify-center gap-3">
                ...
                <Link href="/" className="text-black font-bold transition-colors duration-200 bg-zinc-200 py-1 px-3 rounded-lg hover:invert active:scale-95">Log In</Link>
                <Link href="/" className="text-zinc-200 font-bold transition-colors duration-200 hover:text-zinc-200 hover:bg-black bg-orange-700 py-1 px-3 rounded-lg active:scale-95">Sing Up</Link>
            </div>
